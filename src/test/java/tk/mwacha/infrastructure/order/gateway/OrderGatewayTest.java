...
import tk.mwacha.helper.MockOrderHelper;
...
class OrderGatewayTest {
  ...
  void should_create_a_new_order() {
    ...
    final var orderItem = MockOrderHelper.buildOrderItem(product);

    final var order = MockOrderHelper.buildOrder(customer, List.of(orderItem));
  ...
  void should_update_a_order() {
    ...
    final var orderItem2 = MockOrderHelper.buildOrderItem(product2);
  ...
  void should_find_all_orders() {
    ...
    final var order = MockOrderHelper.buildOrder(customer, List.of(orderItem));
    final var order2 = MockOrderHelper.buildOrder(customer, List.of(orderItem2));
